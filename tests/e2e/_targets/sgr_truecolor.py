...
write_bytes(h_out, b'\x1b[38;2;0;0;0m')
write_bytes(h_out, b'\x1b[38;2;255;255;255m')
write_bytes(h_out, b'\x1b[38;2;12;34;56m')
write_bytes(h_out, b'\x1b[48;2;200;100;50m')
done()