...
write_bytes(h_out, b'\x1b[10;20H')
write_bytes(h_out, b'\x1b[5A')
write_bytes(h_out, b'\x1b[5B')
write_bytes(h_out, b'\x1b[5C')
write_bytes(h_out, b'\x1b[5D')
write_bytes(h_out, b'\x1b[10G')
write_bytes(h_out, b'\x1b[10d')
write_bytes(h_out, b'\x1b[3E')
write_bytes(h_out, b'\x1b[3F')
done()