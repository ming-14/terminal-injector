...
write_bytes(h_out, b'\x1b[1m')
write_bytes(h_out, b'\x1b[3m')
write_bytes(h_out, b'\x1b[4m')
write_bytes(h_out, b'\x1b[5m')
write_bytes(h_out, b'\x1b[7m')
write_bytes(h_out, b'\x1b[8m')
write_bytes(h_out, b'\x1b[9m')
write_bytes(h_out, b'\x1b[0m')
done()