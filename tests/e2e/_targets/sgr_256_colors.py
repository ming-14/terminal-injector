...
write_bytes(h_out, b'\x1b[38;5;0m')
write_bytes(h_out, b'\x1b[38;5;16m')
write_bytes(h_out, b'\x1b[38;5;17m')
write_bytes(h_out, b'\x1b[38;5;255m')
write_bytes(h_out, b'\x1b[48;5;196m')
done()