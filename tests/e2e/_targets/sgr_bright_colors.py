...
write_bytes(h_out, b'\x1b[90m')
write_bytes(h_out, b'\x1b[91m')
write_bytes(h_out, b'\x1b[97m')
write_bytes(h_out, b'\x1b[100m')
write_bytes(h_out, b'\x1b[101m')
write_bytes(h_out, b'\x1b[107m')
done()